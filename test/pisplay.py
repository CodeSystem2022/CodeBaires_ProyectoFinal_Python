...
def displayComboBurguerEspecial(comboBurguerBaconFrame, comboBurguerVeggieFrame, comboBurguerClasicaFrame, comboBurguerEspecialFrame,
 ...
 def displayEspresso(comboBurguerBaconFrame, comboBurguerVeggieFrame, comboBurguerClasicaFrame, comboBurguerEspecialFrame,
    ...
    def displayMuffinArandano(comboBurguerBaconFrame, comboBurguerVeggieFrame, comboBurguerClasicaFrame, comboBurguerEspecialFrame,
                                ...
                                displayLabel, images):
        # Instanciamos la imagen correspondiente al item del menú, la traemos de images.py
        muffinArandanoImage = images['muffinArandanoImage']

        muffinArandanoFrame.configure(
            relief='sunken',  # le asigna al marco o frame que va a contener este item un relieve hundido
            style='selectedDish.TFrame' # le asigna el estilo configurado en la clase style para selectedDish que sería el item seleccionado
        )
        #  Luego, configuramos el estilo del resto de los otros marcos
        ...
        # padding: es el espaciado entre los elementos
        displayLabel.configure(
            image=muffinArandanoImage,
            text='Muffin de Arandanos',
            font=('Franklin Gothic', 10, 'bold'),
            foreground='white',
            compound='bottom',
            padding=(2, 2, 2, 2)
    ...
    def displayMuffinChips(comboBurguerBaconFrame, comboBurguerVeggieFrame, comboBurguerClasicaFrame, comboBurguerEspecialFrame,
                                capuccinoFrame, espressoFrame, latteFrame, muffinArandanoFrame, muffinChipsFrame, muffinChocolateFrame,
                                displayLabel, images):
        # Instanciamos la imagen correspondiente al item del menú, la traemos de images.py
        muffinChipsImage = images['muffinChipsImage']

        muffinChipsFrame.configure(
            relief='sunken',  # le asigna al marco o frame que va a contener este item un relieve hundido
            style='selectedDish.TFrame' # le asigna el estilo configurado en la clase style para selectedDish que sería el item seleccionado
        )
        #  Luego, configuramos el estilo del resto de los otros marcos
        ...
        # padding: es el espaciado entre los elementos
        displayLabel.configure(
            image=muffinChipsImage,
            text='Muffin de Vainilla con chips',
            font=('Franklin Gothic', 10, 'bold'),
            foreground='white',
            compound='bottom',
            padding=(2, 2, 2, 2)
    ...
    def displayMuffinChocolate(comboBurguerBaconFrame, comboBurguerVeggieFrame, comboBurguerClasicaFrame, comboBurguerEspecialFrame,
                                capuccinoFrame, espressoFrame, latteFrame, muffinArandanoFrame, muffinChipsFrame, muffinChocolateFrame,
                                displayLabel, images):
        # Instanciamos la imagen correspondiente al item del menú, la traemos de images.py
        muffinChocolateImage = images['muffinChocolateImage']
        muffinChocolateFrame.configure(
            relief='sunken',  # le asigna al marco o frame que va a contener este item un relieve hundido
            style='selectedDish.TFrame'# le asigna el estilo configurado en la clase style para selectedDish que sería el item seleccionado
        )
        #  Luego, configuramos el estilo del resto de los otros marcos
